...
const TowerOfHanoi = () => {
    ...
    const handleClickOnTower = (towerId) => {
        console.log("Tower " + towerId + " clicked!");
    }

    const [towers, setTowers] = useState(() => {
        let arr = [];
        arr.push(<Tower handleClickOnTower={handleClickOnTower} id={1} discs={[1,1,1,1]}/>);
        arr.push(<Tower handleClickOnTower={handleClickOnTower} id={2} discs={[0,0,0,0]}/>);
        arr.push(<Tower handleClickOnTower={handleClickOnTower} id={3} discs={[0,0,0,0]}/>);
